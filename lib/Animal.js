class Animal {
    ...
    die(state, index) {
        ...
        state[this.type].instances = animals.splice(index,1);
    }
    ...
    mate (state) {
        state[this.type].instances.push(new Animal('baby','Ÿ', 238, 15, this.type, this.x_pos, this.y_pos));
    }
