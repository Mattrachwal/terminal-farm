...
let chicken1 = new Chicken('1', '\x1b[41m\x1b[36mŸ\x1b[0m', 'chicken');
let chicken2 = new Chicken('2', '\u001b[38;5;136mŸ\x1b[0m', 'chicken');
const chickens = [chicken1, chicken2];

for (let c  = 0; c < 2; c++) {
	chickens.push(new Chicken(c, '\u001b[38;5;136mŸ\x1b[0m', 'chicken'));
}
